...
namespace uNature.Core.Utility
{
    ...
    public class FoliageWorldMaps
    {
        ...
        public void UpdateHeightsAndNormals(Terrain terrain)
        {
            ...
            var heights = terrain.terrainData.GetHeights(0, 0, terrain.terrainData.heightmapWidth, terrain.terrainData.heightmapHeight);
            ...
            for (int x = 0; x < size; x++)
            {
                for (int z = 0; z < size; z++)
                {
                    ...
                    xIndex = ((xIndex / terrainSizeX) * (terrain.terrainData.heightmapWidth - 1));
                    zIndex = ((zIndex / terrainSizeZ) * (terrain.terrainData.heightmapHeight - 1));
