...
namespace uNature.Core.FoliageClasses
{
    ...
    public sealed class FoliagePrototype : BasePrototypeItem
    {
        ...
        [SerializeField]
        bool _useCustomFadeDistance = false;
        ...
        public int fadeDistance
        {
            ...
            set
            {
                if (_fadeDistance != value)
                {
                    ...
                    if (FoliageCore_MainManager.instance != null && (_tempUseFadeDistance == useCustomFadeDistance)) // if FoliageCore_MainManager != null && custom fade distance didn't change.
                    {
                        FoliageMeshManager.GenerateFoliageMeshInstances();
