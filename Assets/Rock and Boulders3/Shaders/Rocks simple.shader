...
Shader "MK4/Rocks_simple"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = lerp( clamp( ( (float4( 0.3,0.3,0.3,0.3 ) + (lerp( float4(1,1,1,1) , tex2DNode38 , _MicrodetailAlbedo ) - float4( 0,0,0,0 )) * (float4( 1.3,1.3,1.3,1.3 ) - float4( 0.3,0.3,0.3,0.3 )) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) * ( clamp( (float4( -1,-1,-1,-1 ) + (lerp( float4(0.5,0.5,0.5,0.5) , tex2DNode38 , _MicrodetailAlbedo ) - float4( 0,0,0,0 )) * (float4( 0.9,0.9,0.9,0.9 ) - float4( -1,-1,-1,-1 )) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) ) + tex2D( _RockAlbedo, uv_RockAlbedo ) ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) ) , tex2DNode9 , clamp( ( tex2DNode9.a * ((-3.0 + (_CoverAmount - 0.0) * (-0.2 - -3.0) / (1.0 - 0.0)) + (WorldNormalVector( i , tex2DNode4 ).y - 0.0) * ((0.0 + (_CoverAmount - 0.0) * (10.0 - 0.0) / (1.0 - 0.0)) - (-3.0 + (_CoverAmount - 0.0) * (-0.2 - -3.0) / (1.0 - 0.0))) / (1.0 - 0.0)) ) , 0.0 , 1.0 ) ).xyz;
...
/*ASEBEGIN
Version=10001
13;195;1202;838;1274.239;655.856;2.458404;True;True
Node;AmplifyShaderEditor.RangedFloatNode;34;-2112.571,-795.8618;Float;False;Property;_MicrodetailTiling;Microdetail Tiling;8;0;0.5;0;1;0;1;FLOAT
Node;AmplifyShaderEditor.TFHCRemap;35;-1833.265,-838.5614;Float;False;5;0;FLOAT;0.0;False;1;FLOAT;0.0;False;2;FLOAT;1.0;False;3;FLOAT;1.0;False;4;FLOAT;20.0;False;1;FLOAT
Node;AmplifyShaderEditor.TextureCoordinatesNode;36;-1659.761,-859.906;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.RangedFloatNode;48;-396.2135,-598.4387;Float;False;Property;_MicrodetailAlbedo;Microdetail Albedo;7;0;0.5;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-2117.989,-531.4485;Float;False;Property;_CoverTiling;Cover Tiling;11;0;0.5;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-2236.619,-134.225;Float;False;Property;_CoverAmount;Cover Amount;10;0;0.5;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;621.3304,72.07998;Float;False;True;2;Float;ASEMaterialInspector;0;Standard;MK4/Rocks_simple;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;3;False;0;0;Opaque;0.5;True;True;0;False;Opaque;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;False;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;Relative;0;;-1;-1;-1;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;13;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=7B46418B66B9146252C2391E1F55DBBE9AD3CB2A