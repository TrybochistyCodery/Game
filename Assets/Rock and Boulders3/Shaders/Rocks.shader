...
Shader "MK4/Rocks"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Normal = normalize( BlendNormals( BlendNormals( UnpackScaleNormal( tex2D( _RockNormal, uv_RockNormal ) ,(0.0 + (_NormalPower - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) , lerp( float3(0,0,1) , UnpackScaleNormal( tex2D( _CoverNormal, i.texcoord_0 ) ,(0.0 + (_CoverNormalPower - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) , saturate( WorldNormalVector( i , UnpackScaleNormal( tex2D( _RockNormal, uv_RockNormal ) ,(0.0 + (_NormalPower - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) ).y ) ) ) , UnpackScaleNormal( tex2D( _MicrodetailNormal, i.texcoord_1 ) ,(0.0 + (_MicrodetailNormalPower - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) ) );
			...
			o.Albedo = lerp( clamp( ( (float4( 0.3,0.3,0.3,0.3 ) + (lerp( float4(1,1,1,1) , tex2DNode38 , _MicrodetailAlbedo ) - float4( 0,0,0,0 )) * (float4( 1.3,1.3,1.3,1.3 ) - float4( 0.3,0.3,0.3,0.3 )) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) * ( clamp( (float4( -1,-1,-1,-1 ) + (lerp( float4(0.5,0.5,0.5,0.5) , tex2DNode38 , _MicrodetailAlbedo ) - float4( 0,0,0,0 )) * (float4( 0.9,0.9,0.9,0.9 ) - float4( -1,-1,-1,-1 )) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) ) + tex2D( _RockAlbedo, uv_RockAlbedo ) ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) ) , tex2DNode9 , clamp( ( tex2DNode9.a * ((-3.0 + (_CoverAmount - 0.0) * (-0.2 - -3.0) / (1.0 - 0.0)) + (WorldNormalVector( i , BlendNormals( BlendNormals( tex2DNode4 , lerp( float3(0,0,1) , UnpackScaleNormal( tex2D( _CoverNormal, i.texcoord_0 ) ,(0.0 + (_CoverNormalPower - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) , saturate( WorldNormalVector( i , tex2DNode4 ).y ) ) ) , UnpackScaleNormal( tex2D( _MicrodetailNormal, i.texcoord_1 ) ,(0.0 + (_MicrodetailNormalPower - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) ) ).y - 0.0) * ((0.0 + (_CoverAmount - 0.0) * (10.0 - 0.0) / (1.0 - 0.0)) - (-3.0 + (_CoverAmount - 0.0) * (-0.2 - -3.0) / (1.0 - 0.0))) / (1.0 - 0.0)) ) , 0.0 , 1.0 ) ).xyz;
			...
			o.Occlusion = clamp( (temp_cast_4 + (desaturateVar83 - float3( 0.0,0,0 )) * (float3( 1.0,0,0 ) - temp_cast_4) / (float3( 1.0,0,0 ) - float3( 0.0,0,0 ))) , float3( 0.0,0,0 ) , float3( 1.0,0,0 ) ).x;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=10001
13;195;1202;838;3048.229;31.94315;1.700855;True;True
...
Node;AmplifyShaderEditor.SamplerNode;4;-1576.366,197.6078;Float;True;Property;_RockNormal;Rock Normal;1;0;Assets/Rock and Boulders3/origin/Textures/Rock01_n.tif;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;14;-1596.566,394.9421;Float;True;Property;_CoverNormal;Cover Normal;12;0;Assets/Rock and Boulders3/Ground/Ground_04_nmp.tif;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;38;-407.492,-956.4921;Float;True;Property;_Microdetail;Microdetail;6;0;Assets/Rock and Boulders3/origin/Details/Detail_01.tif;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;32;-1622.238,613.9823;Float;True;Property;_MicrodetailNormal;Microdetail Normal;7;0;Assets/Rock and Boulders3/origin/Details/Detail_01_nmp.tif;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT3;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;1;-811.4,-722.1001;Float;True;Property;_RockAlbedo;Rock Albedo;0;0;Assets/Rock and Boulders3/origin/Textures/Rock01_a.tif;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;9;-892.2139,-517.8035;Float;True;Property;_CoverAlbedo;Cover Albedo;11;0;Assets/Rock and Boulders3/Ground/Ground_04.tif;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;72;-531.5165,-152.2744;Float;False;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;621.3304,72.07998;Float;False;True;2;Float;ASEMaterialInspector;0;Standard;MK4/Rocks;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;3;False;0;0;Opaque;0.5;True;True;0;False;Opaque;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;False;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;Relative;0;;-1;-1;-1;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;13;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=E9D1DCCDEA03BBAD2B72CBBE656934D9C905995C